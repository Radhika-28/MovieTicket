...
<br><br>
<div class="center">
<button onclick="window.location.href='D:\xampp\htdocs\SD_Project\payment.html';"  class="btn btn-secondary" id="btn1" style="align-items:center";> Payment</button>
    </div>
...
$db = mysqli_select_db($connection,'ticketbooking');
